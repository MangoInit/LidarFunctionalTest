...
#include "../LidarFunctionalTest/flashgodriver.h"
...
void FlashgoDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FlashgoDriver::*)(LidarResultDisplay );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FlashgoDriver::sg_result_dis)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FlashgoDriver::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FlashgoDriver::sg_uart_dis)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (FlashgoDriver::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FlashgoDriver::sg_loop_end)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FlashgoDriver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FlashgoDriver.data,
      qt_meta_data_FlashgoDriver,  qt_static_metacall, nullptr, nullptr}
};
