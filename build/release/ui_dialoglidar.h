...
"background-color: rgb(211, 215, 207);"));
        ...
        pushButton->setGeometry(QRect(120, 20, 61, 31));
        ...
        widget = new QWidget(DialogLidar);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(20, 219, 161, 111));
        ...
        gridLayout_2->addWidget(pushButton_open, 0, 0, 1, 1);

        pushButton_MoterEn = new QPushButton(widget);
        ...
        gridLayout_2->addWidget(pushButton_MoterEn, 0, 1, 1, 1);

        pushButton_getInfo = new QPushButton(widget);
        pushButton_getInfo->setObjectName(QStringLiteral("pushButton_getInfo"));

        gridLayout_2->addWidget(pushButton_getInfo, 1, 0, 1, 1);

        pushButton_getHealth = new QPushButton(widget);
        pushButton_getHealth->setObjectName(QStringLiteral("pushButton_getHealth"));

        gridLayout_2->addWidget(pushButton_getHealth, 1, 1, 1, 1);

        pushButton_IntensityON = new QPushButton(widget);
        pushButton_IntensityON->setObjectName(QStringLiteral("pushButton_IntensityON"));

        gridLayout_2->addWidget(pushButton_IntensityON, 2, 0, 1, 1);

        pushButton_IntensityOFF = new QPushButton(widget);
        pushButton_IntensityOFF->setObjectName(QStringLiteral("pushButton_IntensityOFF"));

        gridLayout_2->addWidget(pushButton_IntensityOFF, 2, 1, 1, 1);

        pushButton_stopScan = new QPushButton(widget);
        pushButton_stopScan->setObjectName(QStringLiteral("pushButton_stopScan"));

        gridLayout_2->addWidget(pushButton_stopScan, 3, 0, 1, 2);
